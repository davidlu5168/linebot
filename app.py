...
# LINE bot 設置
LINE_CHANNEL_ACCESS_TOKEN = 'N+T0oCWjOfRycbkFRtgqptOTR0zNm6ztBYB9cdOlXKHEAEUwepd/kQDcLe8wQfUIIkZ1rmQDwnbQZ12Xxkc2bnyHJ/eG7TT2lyMoWcwmRVi1kVrSAqoE3pz0oDq7RTpDgNwrcaBzAL5Ec2dafbYIvAdB04t89/1O/w1cDnyilFU='
LINE_CHANNEL_SECRET = '5ab803ef4719b4453324c9a68cb855d0'
SERVER_URL = 'https://linebotapi-tylo.onrender.com/webhook'
...
llm_model = AutoModelForCausalLM.from_pretrained("Qwen/Qwen1.5-0.5B").to(torch.device("cuda" if torch.cuda.is_available() else "cpu"))
